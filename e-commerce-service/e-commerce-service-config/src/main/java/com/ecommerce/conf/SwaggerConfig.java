...
public class SwaggerConfig {
    ...
    /**
     * <h2> 配置 Swagger 的描述信息</h2>
     * */
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("imooc-micro-service")
                .description("e-commerce-spirngcloud-service")
                .contact(new Contact("Sihui He", "she334@uwo.ca", "she334@uwo.ca"))
                .version("1.0")
                .build();
    }
}
